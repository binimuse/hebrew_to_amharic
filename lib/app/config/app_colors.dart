...
class AppColors {
  static const darkBlue = Color(0xff18385A);
  static const appLightBlue = Color(0xffb1c9e3);
  static const lightBlue = Color.fromARGB(255, 53, 117, 185);
  static const gold = Color(0xffE4A400);
  ...
  //PRIMARY
  static Color primary = const Color(0xff5DB962);
  static Color primaryDark = Color.fromARGB(255, 24, 58, 26);
  static Color primaryLight = Color.fromARGB(255, 138, 216, 142);
  static Color primaryLighter = Color.fromARGB(255, 182, 228, 184);
  ...
  //WARNING
  static Color warningDefault = const Color(0xffffd02c);
  static Color warningDark = const Color(0xffc28000);
  static Color warningLight = const Color(0xfffff8d0);
  ...
  ///
  static Color green = Color(0xff008080);
  static Color greenLight = Color(0xff00FF38);
  static Color greenDark = Color(0xff418A8A);
  static Color dimGreen = Color(0xffD6EFEE);

  static Color greenGradientOne = Color(0xff8BB9C2);
  static Color greenGradientTwo = Color(0xff23AAAA);
}
